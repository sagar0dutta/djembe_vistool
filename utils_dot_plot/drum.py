...
def analyze_phases(cycles_csv_path, onsets_csv_path, onset_type, dance_mode_time_segments=None, save_path=None, SIG=0.01, figsize=(12, 8), dpi=100, use_window=True):
    ...
    plot_results(phases, window_positions, kde_xx, kde_h, file_name, onset_type, 
