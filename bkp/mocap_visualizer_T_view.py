...
class MocapVisualizer:
    ...
    def build_skeleton(self, frame):
        ...
        # For top view, we don't need to calculate forward direction or rotation
        # Just apply translation to keep the skeleton centered
    ...
    def generate_video(self, start_time=0, end_time=None, output_file="animation.mp4", output_fps=30, video_size=(1920, 1080)):
...
if __name__ == "__main__":
    ...
    visualizer.generate_video(
        output_file="output_T_view.mp4",
        start_time=75.0,  # Start at 75 seconds
        end_time=78.0,    # End at 85 seconds
        output_fps=24,    # Set to standard video frame rate
        video_size=(640, 480)  # Set video size to 1920x1080 (Full HD)
    ) 